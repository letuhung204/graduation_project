...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>R</b>Đ</span>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#" th:href="@{/staff}"><i class="fa fa-link"></i> <span>Account Manager</span></a></li>
        <li class="active"><spring:url value="/staff" var="listURL" />
							<a class="" href="${listURL}" role="list"><i class="fa fa-link"></i> <span>Staff Manager</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Project Manager</span> <i class="fa fa-angle-left pull-right"></i></a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		<div class="container">
		<h1 style="text-align: center">Bảng Danh Sách Staff !</h1>

		<form class="form-inline" action="/staff/search">
			<div>
		...
		<table class="table table-boder table-hover table-bordered">
			<thead>
				<tr>
					<th>#</th>
					<th>First Name</th>
			...
			<tbody>
				...
				<c:forEach items="${staffs }" var="staff" varStatus="s">
					<tr>
						...
						<td><spring:url value="/staff/${staff.id}/edit" var="editURL" />
							<a class="btn btn-warning" href="${editURL}" role="button">Sửa</a>
							</a> <spring:url value="/staff/${staff.id}/delete" var="deleteURL" />
							<a class="btn btn-danger" href="${deleteURL}" role="button"
							onclick="return confirm('Bạn chắc chắn xoá Staff có tên : ${staff.firstname} ?');">Xoá</a>
							</a></td>
					</tr>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Team Graduation Project <a href="#">Rạng Đông Company</a>   </strong> Hùng - Thành - Đại.
  </footer>
